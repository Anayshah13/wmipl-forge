    ...
    return (
        <div id="clients" className="relative h-screen w-full overflow-hidden bg-gray-200 flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-[1400px] px-6 flex flex-col xl:flex-row gap-8 items-start justify-center h-auto xl:h-full max-h-[90vh]">
                ...
                <div className="flex-1 flex flex-col items-center justify-start h-full">
                    <div className="mb-6 self-start w-full">
                        <motion.h3
                            ...
                            className="text-2xl md:text-3xl font-black text-gray-800 uppercase tracking-tighter flex items-center gap-4 relative"
                        >
                    ...
                    <div className="grid grid-cols-3 gap-4 w-full h-auto aspect-[4/3] max-h-[70vh]">
                ...
                <div className="w-full xl:w-[400px] flex flex-col justify-start h-full">
                    <div className="mb-6 self-start w-full">
                        <motion.h3
                            initial={{ opacity: 0, x: 20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            className="text-2xl md:text-3xl font-black text-gray-800 uppercase tracking-tighter flex items-center gap-4 xl:justify-start"
                        >
                            <span className="w-12 h-1 bg-blue-600"></span>
                            Marquee Suppliers
                        </motion.h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full aspect-square max-h-[50vh] xl:max-h-none">
