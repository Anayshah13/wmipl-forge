      ...
      <div className="w-[95%] md:w-[87%] mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-8 flex flex-col h-full">
            ...
            {/* Carousel Area */}
            <div className="relative w-full py-2 flex items-center justify-center gap-6">

              {/* Prev Button - Left of Center */}
              <button onClick={handlePrev} className="absolute left-0 top-1/2 -translate-y-1/2 z-20 h-10 w-10 rounded-full border border-gray-200 bg-white shadow-md flex items-center justify-center text-gray-600 hover:text-blue-600 hover:scale-110 transition-all">
                <ChevronLeft size={20} />
              </button>
              ...
              <div className="w-full md:w-3/5 z-10 relative">
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden flex flex-col h-[520px]"
                >
                  {/* Image Section - No Padding, Full Bleed */}
                  <div className="h-[55%] relative bg-gradient-to-b from-gray-50 to-white flex items-center justify-center overflow-hidden">
                  ...
                  <div className="p-6 flex-grow flex flex-col justify-start bg-white relative">
                    <div className="mb-3">
                      <h3 className="text-2xl font-bold text-gray-900 tracking-tight mb-1">{rawProducts[carouselIndex].name}</h3>
                      <p className="text-sm text-blue-600 font-semibold">{rawProducts[carouselIndex].subname}</p>
                    </div>
                    <div className="w-12 h-1 bg-gray-100 rounded mb-4"></div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xl flex flex-col"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="h-5 w-1 bg-blue-800 rounded-full"></div>
                <h3 className="text-lg font-bold text-gray-900 uppercase">
